...
<style>
/* Sidebar */
.w3-sidebar { width: 120px; background-color:#222; }
/* Fonte */
...
<nav class="w3-sidebar w3-bar-block w3-center w3-blue">
  ...
  <a href="#dPessoais" class="w3-bar-item w3-button w3-hover-light-grey w3-hover-text-cyan w3-text-light-grey">
    <i class="fa fa-address-book-o w3-xxlarge"></i><p>Dados Pessoais</p>
  </a>
  <a href="#formacao" class="w3-bar-item w3-button w3-hover-light-grey w3-hover-text-cyan w3-text-light-grey">
    <i class="fa fa-mortar-board w3-xxlarge"></i><p>Formação</p>
  </a>
</nav>
<!--  principal -->
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center" id="home">
    <h1>
      <img src="../Img/LOGO.png" alt="Logo" class="w3-image" width="50%">
    </h1>
...
<div class="w3-padding-128 w3-content w3-text-grey" id="outrasFormacoes">
  ...
  <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
    ...
    <div class="w3-row w3-section">
      ...
      <div class="w3-rest">
        <div class="w3-col w3-margin-left" style="width:13%;"><i class="w3-xxlarge fa fa-calendar"></i></div>
        <div class="w3-rest">
  ...
  <div class="w3-padding-128 w3-content w3-text-grey" id="formacao">
    ...
    <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
      ...
      <div class="w3-row w3-section">
        <div class="w3-col" style="width:45%;">
          <div class="w3-col" style="width:15%;"><i class="w3-xxlarge fa fa-calendar"></i></div>
          <div class="w3-rest"><input class="w3-input w3-border w3-round-large" name="txtInicioFA" type="date"></div>
        </div>
        <div class="w3-rest">
          <div class="w3-col w3-margin-left" style="width:13%;"><i class="w3-xxlarge fa fa-calendar"></i></div>
          <div class="w3-rest"><input class="w3-input w3-border w3-round-large" name="txtFimFA" type="date"></div>
        </div>
      </div>
      <div class="w3-row w3-section">
        <div class="w3-col" style="width:7%;"><i class="w3-xxlarge fa fa-align-justify"></i></div>
        <div class="w3-rest"><input class="w3-input w3-border w3-round-large" name="txtDescFA" type="text" placeholder="Descrição: Ex.: Técnico em Desenvolvimento de Sistemas - Centro Paula Souza"></div>
      </div>
      <div class="w3-row w3-section">
        <div class="w3-center">
  ...
  <div class="w3-padding-128 w3-content w3-text-grey" id="eProfissional">
    ...
    <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
      ...
      <div class="w3-row w3-section">
        <div class="w3-col" style="width:7%;"><i class="w3-xxlarge fa fa-building"></i></div>
        <div class="w3-rest">
